!(function (e, t) {
    ...
    ((S.fn.init = function (e, t, n) {
        ...
        return (
            (e = E.getElementById(r[2])) && ((this[0] = e), (this.length = 1)),
            this
        );
    }).prototype = S.fn),
        (D = S(E));
    ...
    function qe(n, r, i, o) {
        ...
        if (
            ...
            if (s)
                for (
                    l = a[a.length - 1].ownerDocument, S.map(a, je), c = 0;
                    c < s;
                    c++
                )
                    (u = a[c]),
        ...
        S.extend({
            ...
            ajax: function (e, t) {
                ...
                h.ifModified &&
                    ...
                    S.etag[l] &&
                        w.setRequestHeader("If-None-Match", S.etag[l])),
                ...
                function T(e, t, n, r) {
                    ...
                    p ||
                        ...
                        (w.statusText = (t || s) + ""),
                        r
                            ? m.resolveWith(g, [i, s, w])
                            : m.rejectWith(g, [w, s, o]),
                        w.statusCode(x),
                        (x = void 0),
                        d &&
