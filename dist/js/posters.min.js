var deleteCommentFilmIdentifier = void 0,
...
async function generateFilmModal(e, t) {
    ...
    g.appendChild(A), g.appendChild(m), b.appendChild(g);
    ...
    for (l__Item in (y.appendChild(m), w.appendChild(y), t.actor)) {
        var L = document.createTextNode(t.actor[l__Item].name);
        w.appendChild(L);
    }
    b.appendChild(w);
    ...
    I.appendChild(T), I.appendChild(m), b.appendChild(I);
    ...
    (q.textContent = "2"), z.appendChild(q);
    let W = document.createElement("option");
    (W.textContent = "3"), z.appendChild(W);
    let O = document.createElement("option");
    (O.textContent = "4"), z.appendChild(O);
    ...
    J.setAttribute("class", "form-control"),
        J.setAttribute("id", "inputComment" + t.identifier),
        J.setAttribute("name", "inputComment" + t.identifier),
        J.setAttribute("aria-describedby", "opinionTextareaHelp"),
        J.setAttribute("placeholder", "p.e. Esta película..."),
        J.setAttribute("required", !0),
        G.appendChild(Q),
        G.appendChild(J),
        H.appendChild(G);
    let K = document.createElement("div");
    K.setAttribute("id", "commentFormBtn" + t.identifier),
        K.setAttribute("class", "row d-none");
    let X = document.createElement("div");
    X.setAttribute("class", "col-12 p-1 d-flex justify-content-end");
    let Y = document.createElement("button");
    Y.setAttribute("class", "btn btn-primary"),
        Y.setAttribute("id", "addComment" + t.identifier),
        (Y.textContent = "Añade tu comentario"),
        X.appendChild(Y),
        K.appendChild(X);
